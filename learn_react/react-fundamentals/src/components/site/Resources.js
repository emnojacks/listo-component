    ...
    return (
        ...
        <div className="main">
            <div className="mainDiv">
                ...
                <p>
                    Below are some of the resources we used throughout this app.  Note: You will have one challenge where you will be asked to make this page better.
                </p>
                ...
                <ul>
                    ...
                    <li>
                        <a href="https://www.udemy.com/course/react-redux/" target="_blank">
                            Stephen Griders Udemy Course for the Udemy API
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="https://www.udemy.com/course/react-the-guide-incl-redux/" target="_blank">
                            Max Schwarzmuller's Udemy Course
                        </a>
                    </li>
                
                    <li>
                        <a href="https://reactstrap.github.io/" target="_blank">
                            Reactstrap for a Bootstrap App
                        </a>
                    </li>
